              ...
              BoxShadow(
                ...
                spreadRadius: 0.0,
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        Text('Sign Up',style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold, fontSize: 30,decorationColor: Colors.black,decorationThickness: 2.0,),),
                        SizedBox(height: 20,),
                        ...
                        InkWell(
                          onTap: (() async {
                            if(emailAddressController.text.isEmpty){
                              toast('Please Enter Your Entail Address');
                            }else if(nameController.text.isEmpty){
                              toast('Please Enter Your Name');
                            }else if(phoneNumberController.text.isEmpty){
                              toast('Please Enter Your Phone Number');
                              ...
                              toast('Should be at least 6 digit');
                            }else{
                              try{
                                EasyLoading.show(status: 'Signing Up...');
                                bool status = await AuthRepo().signUpWithEmail(nameController.text, emailAddressController.text, phoneNumberController.text, passwordController.text);
                                if(status){
                                  EasyLoading.showSuccess('Sign Up Successful');
                          ...
                          child: Container(
                            ...
                            child: const Center(child: Text('Sign In', style: TextStyle(color: Colors.white,fontSize: 25, fontWeight: FontWeight.bold),)),
                          ),
                        ),
                       ...
                       Row(
                         ...
                         children: [
                           ...
                           const Text('Sign In Here', style: TextStyle(color: Colors.blue, fontWeight: FontWeight.bold),).onTap(()=>const SignIn().launch(context))
                         ],
                       ),
                      ],
                    ),
